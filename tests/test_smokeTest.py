...
class TestSmokeTest():
  ...
  def test_adminpage(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("bigbug")
  ...
  def test_homepage(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".main-event").click()
  ...
  def test_joinpage(self):
    ...
    self.driver.find_element(By.NAME, "lname").send_keys("Beebo")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("BigBeebo")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("Head Beebo")
